...
export const LisaProductionRunProductFlowSchema = z.object({
  ...
  outputFBM: z.number(),
  outputM3: z.number(),
  runProductCost: z.number().nullable(),
  runProductMarket: z.number().nullable(),
  runProductPurchaseMarket: z.number().nullable(),
  runProductLineCount: z.number(),
  outputInvoiceValue: z.number().nullable(),
...
export const LisaProductionRunSchema = z.object({
  ...
  inventoryGroupId: z.string().nullable(),
  runInputValue: z.number().nullable(),
